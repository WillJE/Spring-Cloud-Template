...
![](images/Lusifer201805292246011.png)
...
![](images/2019051945927.png)

该服务已关闭，继续访问：`localhost:9002/feignHello/tycoding`:

![](images/QQ20190519162209.png)
...
![](images/QQ20190520125046.png)

访问`localhost:9003/api/admin/hello/tycoding?token=123`

![](images/QQ20190520125103.png)
...
![](images/QQ20190521141906.png)

​		为该服务执行`mvn clean package`命令即可：

![](images/QQ20190521143322.png)

最后启动完成，访问`localhost:8004`

![](images/2019052124045.png)
